...
description: A simulation study of the mighty *Slay the Spire* relic
categories:
- r
- simulations
image_header:
  overlay_image: 2021-07-ss-bg.jpg
...
title-block-banner: 2021-07-ss-bg.jpg
image: 2021-07-ss-bg.jpg
aliases:
- /slay-the-spire-snecko-eye-simulation/
---
...
![Screenshot of *Slay the Spire* gameplay. We see a hand of 5 cards at the bottom with 1/3 energy available on the left.](2021-07-ss.jpg){fig-alt="A screenshot of Slay The Spire gameplay."}
...
simulate some draws by `sample()`-ing without replacement.
...
![Snecko Eye is probably the best relic in the game.](2021-07-snecko.png){fig-alt="A screenshot of Snecko Eye."}
...
#| out.width: 100%
#| fig.alt: >
#|   A one by three plot showing a histogram of playable cards for each simulation
#|   set. It's title says 'Confusion increases variance. Card draw increases mean.'
library(ggplot2)
...
#| out.width: 80%
#| fig.alt: >
#|   A plot of the ECDF for the proportion of hands with at least x playable 
#|   cards. Snecko dominates the other lines in the plot because we can play 
#|   more cards per turn with it. There is a caption at the center of the 
#|   plot that says 'Snecko can play 4 or more cards in 60% of hands'.
#| fig.cap: >
#|   A plot of the ECDF for the proportion of hands with at least x playable 
#|   cards. Snecko dominates the other lines in the plot because we can play 
#|   more cards per turn with it. 
library(dplyr)
...
#| fig.height: 7.0
#| out.width: 100%
#| fig.alt: A three by three plot of simulation set by energy cost.
...
![Pwease no steppo. Posted by  [u/usernameequalspants](https://www.reddit.com/r/slaythespire/comments/l0qm6z/no_step_on_snecko/?ref=share&ref_source=link).](2021-07-no-steppo.jpg){fig-alt="Don't tread on me flag with the Snecko Eye flag."}
