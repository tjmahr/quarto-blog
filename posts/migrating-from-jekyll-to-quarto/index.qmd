...
```{yaml, filename = "yaml front matter"}
# (the key portion of the file)
...
and store it in `partials/title-block.html`. We then modify the file, adding the 5 unindented lines towards the bottom.
